    ...
    <div className="bg-linear-to-b from-slate-900 via-blue-950 to-slate-900 py-15">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6">
          {/* Produktivitas Tugas */}
          <div className="bg-linear-to-br from-blue-600/20 to-cyan-600/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 transform hover:scale-105">
          ...
          {/* Sisa Budget */}
          <div className="bg-linear-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-green-500/30 hover:border-green-500/50 transition-all duration-300 transform hover:scale-105">
            <div className="flex items-center justify-between mb-3">
          ...
          {/* Target Tabungan */}
          <div className="bg-linear-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 transform hover:scale-105">
            <div className="flex items-center justify-between mb-3">
          ...
          {/* Status Hutang */}
          <div className="bg-linear-to-br from-yellow-600/20 to-orange-600/20 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-yellow-500/30 hover:border-yellow-500/50 transition-all duration-300 transform hover:scale-105">
            <div className="flex items-center justify-between mb-3">
