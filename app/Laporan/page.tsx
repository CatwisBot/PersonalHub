...
import PemasukanList from "@/components/shared/Laporan/PemasukanList";
import TugasList from "@/components/shared/Laporan/TugasList";
import HutangList from "@/components/shared/Laporan/HutangList";
import ChartSection from "@/components/shared/Laporan/ChartSection";
  ...
  const fetchData = async () => {
    try {
      ...
      const [pengeluaranData, pemasukanData, tugasData, hutangData, totalIn, totalOut] = await Promise.all([
        getPengeluaran(currentMonth, currentYear), getPemasukan(currentMonth, currentYear), getTugas(), getHutang(),
        getTotalPemasukan(currentMonth, currentYear), getTotalPengeluaran(currentMonth, currentYear),
      ]);
